...
est_field_LL_adaptive = LLfieldAdaptive(X0, X1, x=x, kernel.type="gauss",method.h = NULL,
                        chunk_size=1000, sparse=FALSE, gc=TRUE, hOpt = TRUE, h = NULL,
                         alpha = NULL, alphaOpt = TRUE, nGridAlpha = 5, nGridh = 5)

est_field_NW_opt = NWfield(X0, X1, x=x, kernel.type="gauss",method.h = NULL,
                       chunk_size=1000,
                      sparse=FALSE, gc=TRUE, hOpt = TRUE, nGridh = 5)
...
# bootstrap_est_field_LL = bootstrapKernelFieldErrors(est_field_LL_opt, B = 10, chunk_size = 1000)
