...
est_field_LL_adaptive = LLfieldAdaptive(X0, X1, x=x, kernel.type="gauss",method.h = NULL,
                        chunk_size=500, sparse=FALSE, gc=TRUE, hOpt = TRUE, h = NULL,
                         alpha = NULL, alphaOpt = TRUE, nGridAlpha = 10, nGridh = 10)
...
bootstrap_est_field_LL = bootstrapLLfieldErrors(est_field_LL_adaptive, B = 10, chunk_size = 1000)
